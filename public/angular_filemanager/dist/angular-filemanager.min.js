!function (e, r, n) {
    ...
    r.filter("strLimit", ["$filter", function (e) {
        ...
        var n = [" kB", " MB", " GB", " TB", "PB", "EB", "ZB", "YB"], i = ["KiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB"];
        return function (e) {
            var a = -1, t = e;
    ...
    e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload", function (e, n, i, a, t) {
        ...
        return o.prototype.deferredHandler = function (e, r, n, i) {
            ...
            var t = this, o = a || t.deferredHandler, s = n.defer(), l = {action: "list", path: i};
    ...
    e.module("FileManagerApp").service("apiMiddleware", ["$window", "fileManagerConfig", "apiHandler", function (e, r, n) {
        ...
        return i.prototype.getPath = function (e) {
            ...
            var i = this.getFileList(e), a = (new Date).getTime().toString().substr(8, 13), t = a + "-" + r.multipleDownloadFileName;
            ...
            var i = this.getFileList(e), a = n.tempModel.perms.toCode(), t = n.tempModel.perms.toOctal(), o = !!n.tempModel.recursive;
